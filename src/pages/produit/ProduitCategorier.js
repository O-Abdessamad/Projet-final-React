...
export const ProduitCategorier = (props) => {
    ...
    console.log(categorier);

    const ddd = () => {
        let nb_produit = document.querySelectorAll(".produit_card");
        console.log(nb_produit.length);
        ...
        <div >
            ...
            <div className="main-produit d-flex justify-content-center align-items-center align-items-md-start mt-30 pt-30 pb-30 mb-30 p-30 flex-column flex-md-row ">
                ...
                <div className=' ms-lg-30  ps-lg-30 categories d-flex justify-content-center align-items-center align-items-md-start gap-5 flex-column  w-25'>
                    ...
                    <NavLink to={"/produit/women"} className={"text-decoration-none font-Montserrat text-coleur-gry-nav link_categorier"}>Women</NavLink>
                    <NavLink to={"/produit/kids"} className={"text-decoration-none font-Montserrat text-coleur-gry-nav link_categorier"}>Kids</NavLink>
                    <NavLink to={"/produit/men"} className={"text-decoration-none font-Montserrat text-coleur-gry-nav link_categorier"}>Men</NavLink>
                    <NavLink to={"/produit/accessoire"} className={"text-decoration-none font-Montserrat text-coleur-gry-nav link_categorier"}>Accessoire</NavLink>
                ...
                <div className=' me-lg-30  pe-lg-30 produits '>
                    <p className="font-Montserrat text-coleur-gry-nav text-end me-lg-30  pe-lg-30">Nombre de produit search : {ddd()} all</p>
